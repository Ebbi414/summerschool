...
int main(int argc, char *argv[])
{
    ...
    /* MPI_Alltoall(sendbuf:data to be gathered; sendcount: number of elements pulled from each process; sendtype; recvbuf: receive buffer;
                 recvcounts: number of element received; recvtype; comm: communicator) */
